...
function setupComposer() {
  ...
  const doSend = () => {
    ...
    wsSend({ t: 'msg', text, image: pendingImage, file: pendingFile, spoiler: spoilOn });
...
buildLogin(); setupComposer(); setupVoiceButtons(); setupSoundboard(); setupSovs(); setupWatch(); setupMobile(); setupBottomNav(); setupLogout(); setupHelp(); setupSearch(); setupUIButtons(); setupAfk(); connect();
