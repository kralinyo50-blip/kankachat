...
let myMarket = [];
let roles = [], userRoles = {}, replyTo = null, deaf = false, myStats = null, myAds = [], mySongs = [], myFish = {}, myWeather = 'gunes', chaosUntil = 0;
let chosenMic = null;
...
function applyWeather() {
  const fx = $('#weatherFx');
  fx.className = 'weather-fx w-' + myWeather;
  const pill = $('#weatherPill');
  pill.textContent = { gunes: '☀️', yagmur: '🌧️', kar: '❄️', firtina: '⛈️' }[myWeather] || '☀️';
}
